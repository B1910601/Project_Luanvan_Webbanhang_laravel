                ...
                <tbody>
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href=""><img src="{{URL::to('uploads/product/'.$v_content->options->image)}}" alt="" width="100" /></a>
                        </td>
                        ...
                        <td class="cart_quantity">
                         ...
                         <form action="{{URL::to('/update-cart-quantity')}}" method="POST">
                            {{csrf_field()}}
                                <input class="cart_quantity_input" type="number" min="1" size="1" name="cart_quantity" value="{{$v_content->qty}}"
