...
<li><a href="#"><i class="fa fa-user"></i> {{ $name }}</a></li>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<div class="search_box pull-right">
							...
							{{-- <input type="submit" name="search_item"  class="btn btn-default btn-sm" value="Tìm kiếm"> --}}
						</div>
						</form>
					</div>
				</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>SMART</span>-MOBILE</h1>
									<h3>CỬA HÀNG ĐIỆN THOẠI PHỤ KIỆN </h3>
	...
	<footer id="footer">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2013 SMART-MOBILE Inc. All rights reserved.</p>
