...
class HomeController extends Controller
{
    public function index(Request $request) {
        //seo-meta
        $meta_desc = "Chuyên bán điện thoại laptop phụ kiện";
        ...
        return view('pages.home')->with('category', $cate_product)->with('brand', $brand_product)->with('all_product', $all_product)->with('url_canonical', $url_canonical);
    }
